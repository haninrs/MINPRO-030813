    ...
    <div className="bg-white p-7 ">
      ...
      >
        {() => {
          return (
            <Form>
              <div className="grid place-items-center max-h-full  md:h-screen sm:h-screen">
                <div className="shadow-xl p-5 rounded-lg border-t-4 border-[#000066] bg-white">
                  <h1 className="m-10 text-black text-xl font-bold">
                    Forgot your password?
                  </h1>
                  <p className="text-pretty mx-10 mb-5 text-gray-600">
                  ...
                  <div className="flex justify-center">
                    <button className="bg-[#FFCC00] mx-10 w-2/4 text-white font-bold cursor-pointer py-2  mt-10 rounded-lg">
                      Email me
                    </button>
                  </div>
